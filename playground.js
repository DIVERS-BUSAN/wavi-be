...
import pool from './db.js';    
    ...
    for (const item of items) {
      const { UC_SEQ, MAIN_TITLE, GUGUN_NM, LAT, LNG, PLACE, TITLE, SUBTITLE, ADDR1, CNTCT_TEL, TRFC_INFO, HOMEPAGE_URL } = item;      
      const sql = `
        INSERT INTO 
        (UC_SEQ, MAIN_TITLE, GUGUN_NM, LAT, LNG, PLACE, TITLE, SUBTITLE, ADDR1, CNTCT_TEL, TRFC_INFO, HOMEPAGE_URL)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `;
